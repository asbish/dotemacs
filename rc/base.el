...
(unless (display-graphic-p)
  ...
  (define-key input-decode-map "\e[5;5A" [C-up])
  (define-key input-decode-map "\e[5;5B" [C-down])
  (define-key input-decode-map "\e[5;5C" [C-right])
  (define-key input-decode-map "\e[5;5D" [C-left])
